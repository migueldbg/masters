 ...
 *    the root mean square (RMS), the mean and the peak position. For each parameter, its error is also obtained and the     *
 *    macro then saves it to the corresponding variable. Finally, each parameter is ploted as function of the total charge   *
 *    and the resulting plot is saved as a png and pdf.                                                                      *
 *                                                                                                                           *
 ...
 *    aforementioned macro, please make sure to do so, or else the code will not run as intended.                            *
 *                                                                                                                           *
 * ************************************************************************************************************************* */

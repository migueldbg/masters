...
int plotTPCAlignment(Int_t runNb, Bool_t useLiveTime = false)
{
  ...
  TH2D* fBanana = new TH2D(Form("h0_%d",runNb), Form("Full banana, run %d",runNb), 400, 1500, 7000, 400, 200, 4000);
  TH2D* fCBanana = new TH2D(Form("h1_%d",runNb), "Coincident banana", 400, 1500, 7000, 400, 200, 4000);

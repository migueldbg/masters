...
sernumber=$3
ch_mapping=$4
list_name="list/run_$runumber.lst"
global_name="global_$globalnumber"
laser_name="laser"
ser_name="ser_$sernumber"
RECODIR=/storage/DATA-02/darkside/red/reco/rm3reco/naples/camp_VII/
...
if [ $2 == laser ]
   ...
   ./RedLevel1 -l $list_name -m cfg/$ch_mapping.cfg -c cfg/$global_name.cfg -e ser/$ser_name.cfg -o $RECODIR/$file_name1.root 
